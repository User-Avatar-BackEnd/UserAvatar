...
namespace UserAvatar.Bll.Tests.TaskManager.CommentServiceTests
{
    public class UpdateCommentTests
    {
        ...
        public async Task UpdateComment_If_Board_Does_Not_Exist_Returns_ResultCode_NotFound()
        {
            ...
            // Act
            var result = await commentService.UpdateCommentAsync(It.IsAny<int>(), It.IsAny<int>(), It.IsAny<int>(), It.IsAny<int>(), It.IsAny<string>());
        ...
        public async Task UpdateComment_If_Comment_Does_Not_Exist_In_Card_Returns_ResultCode_NotFound()
        {
            ...
            // Act
            var result = await commentService.UpdateCommentAsync(It.IsAny<int>(), It.IsAny<int>(), It.IsAny<int>(), It.IsNotNull<int>(), It.IsAny<string>());
