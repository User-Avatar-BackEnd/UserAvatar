...
namespace UserAvatar.Bll.Tests.TaskManager.PersonalAccountServiceTests
{
    public class ChangePasswordTests
    {
        ...
        public async Task ChangePassword_If_User_Is_Not_Exist_Returns_ResultCode_NotFound()
        {
            ...
            // Act
            var result = await personalAccountService.ChangePasswordAsync(It.IsAny<int>(), It.IsAny<string>(), It.IsAny<string>());
        ...
        [Fact]
        public async Task ChangePassword_If_OldPassword_Does_Not_Equals_Current_Password_Returns_ResultCode_InvalidPassword()
        {
            // Arrange
