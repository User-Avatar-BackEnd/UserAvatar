...
namespace UserAvatar.Bll.Tests.Gamification
{
    public class RankServiceTests
    {
        ...
        {
            // Arrange
            var inputData = new List<int>() { 0, 10, 100, 300, 500, 700, 900, 999, 1000, 1300 };
            var outputData = new List<string>() { "NPC", "NPC", "Crewman", "Cossack", "Centurion", "Esaul", "Ataman", "Ataman", "Hetman", "Hetman" };
        ...
        private List<Rank> GetDefaultRanks()
        {
            ...
            {
                new Rank{ Name = "NPC", Score = 0 },
                new Rank{ Name = "Crewman", Score = 100 },
                new Rank{ Name = "Cossack", Score = 300 },
                new Rank{ Name = "Centurion", Score = 500 },
                new Rank{ Name = "Esaul", Score = 700 },
                new Rank{ Name = "Ataman", Score = 900 },
                new Rank{ Name = "Hetman", Score = 1000 },
            };
        }
    }
}
