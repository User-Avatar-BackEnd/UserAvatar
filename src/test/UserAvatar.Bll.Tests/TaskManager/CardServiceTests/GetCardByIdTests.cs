...
public sealed class GetCardByIdTests
{
    ...
    [Fact]
    public async Task GetCardById_If_Board_Does_Not_Exist_Returns_ResultCode_NotFound()
    {
        // Arrange
        ...
        // Act
        var result = await cardService.GetCardByIdAsync(It.IsAny<int>(), It.IsAny<int>(), It.IsAny<int>());
    ...
    [Fact]
    public async Task GetCardById_If_Not_User_Board_Returns_ResultCode_NotFound()
    {
        // Arrange
        _cardStorage.Setup(x => x.GetByIdAsync(It.IsAny<int>()))
    ...
    [Fact]
    public async Task GetCardById_If_Success_Deleted_Returns_ResultCode_Success()
    {
        // Arrange
        _cardStorage.Setup(x => x.GetByIdAsync(It.IsAny<int>()))
            .ReturnsAsync(new Card());
